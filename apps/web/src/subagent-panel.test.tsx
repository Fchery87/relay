...
test("renders an editable role roster and drillable subagent tree", () => {
  const html = renderToStaticMarkup(<SubagentPanel onUpdateRole={() => undefined} roles={[{
    _id: "role", capabilities: ["read", "task"], contextMode: "fresh", description: "Map code", maxTurns: 20, modelId: "deepseek/deepseek-v4-flash", name: "explore", prompt: "Explore", thinkingLevel: "high", writer: false,
  }]} runs={[{
